...
def get_comments(driver : uc.Chrome, waitObj: wait.WebDriverWait, pagenumber, sess):
...
with app.app_context():
    ...
    sess=db.session()
    # last_stored_comment=sess.execute(db.select(Comment)).order_by(Comment.id.desc()).fetchone()
